...
function fetchDeclaration(
  token,
  id
) {
  return http.post(`http://localhost:7070/graphql`, JSON.stringify({
...
function getDeclarations(
  ...
  const response = http.post(`http://localhost:7070/graphql`, JSON.stringify({
...
export function setup() {
  ...
  return { token, declarations: getDeclarations(token) }
}


export default function ({ token, declarations }) {
